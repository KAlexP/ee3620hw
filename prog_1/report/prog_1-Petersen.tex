...
In this section there will be brief descriptions of the code followed by the code. I split the program into 
multiple files to have smaller blocks of code in this document. This code could all be included in one file 
just as easily.
...
Below is the makefile that compiles the program.
